...
entity = np.load('/Users/yuchen/my_task/TransE_l2_mywork_19/mywork_TransE_l2_entity.npy')
indexid = pd.read_csv("/Users/yuchen/my_task/TransE_l2_mywork_19/entities.tsv",sep='\t', header = None)
relation = np.load('/Users/yuchen/my_task/TransE_l2_mywork_19/mywork_TransE_l2_relation.npy')
relationid = pd.read_csv("/Users/yuchen/my_task/TransE_l2_mywork_19/relations.tsv",sep='\t', header = None)
...
result_df_sl = pd.read_csv('./result_df_sl_01.csv')
...
#%%
embedding_df.to_csv(r'./imp1/embedding_df_imp1.csv', index = False)
...
acclist.to_csv(r'./amp1/result.csv', index = False)
acc_emlist.to_csv(r'./amp1/result_em.csv', index = False)
